...
#ifndef EMOJI_PICKER_SWIFT_H
#define EMOJI_PICKER_SWIFT_H
...
SWIFT_CLASS("_TtC12emoji_picker11AppDelegate")
...
SWIFT_CLASS("_TtC12emoji_picker27CustomEmojiWindowController")
@interface CustomEmojiWindowController : NSObject <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC12emoji_picker17PickerCoordinator")
@interface PickerCoordinator : NSObject <NSWindowDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC12emoji_picker11PickerPanel")
...
SWIFT_CLASS("_TtC12emoji_picker26StatisticsWindowController")
@interface StatisticsWindowController : NSObject <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
